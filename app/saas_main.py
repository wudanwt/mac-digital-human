...
def _enhanced_dashboard() -> HTMLResponse:
    ...
    body = body.replace(
        ...
        '<script src="/course-studio.js?v=20260920-2"></script>'
        '<script src="/course-studio-upgrade.js?v=20260920-2"></script>'
        '<script src="/system-assets.js"></script>'
        '<script src="/course-studio-asset-picker.js"></script>'
        '<script src="/course-avatar-mode.js?v=20260920-2"></script>'
